...
#                     population, habitat):
def predict_mushroom(odor, 
                    gill_spacing, gill_size,stalk_shape,
                    stalk_surface_above_ring, spore_print_color):
    ...
    probabilty = model.predict_proba(input_encoded)[0]
    ...
    if prediction == 'e':
        ...
        ### The mushroom is predicted to be **EDIBLE** with a probability of {probabilty[0]:.2f}
        ...
        ### The mushroom is predicted to be **POISONOUS** with a probability of {probabilty[1]:.2f}
...
demo = gr.Interface(
    ...
    This classifier uses a trained RandomForestClassifier model on the UCI Mushroom dataset.
